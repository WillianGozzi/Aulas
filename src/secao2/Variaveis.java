...
public class Variaveis {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String lastName = "Gozzi";

        System.out.println("Willian Gozzi");
        ...
        // para ter um resultado quebrado (1.5), pelo menos 1 num da divisao tem que ser double
